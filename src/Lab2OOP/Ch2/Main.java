...
public class Main {
    public static void main(String[] args) {
        Premiu premiu2022 = new Premiu("oscar", 2022);
        Premiu premiu2021 = new Premiu("oscar", 2021);
        Premiu premiu2020 = new Premiu("oscar", 2020);
        Premiu premiu2019 = new Premiu("oscar", 2019);

        Actor actor1 = new Actor("Primul actor", 37, new Premiu[]{premiu2021, premiu2021});
        Actor actor2 = new Actor("Second actor", 32, new Premiu[]{premiu2020});
        Actor actor3 = new Actor("Third actor", 52, new Premiu[]{premiu2019});

        Film film1 = new Film(2016, "Olaf", new Actor[]{actor1, actor2});
        Film film2 = new Film(2015, "Hercule", new Actor[]{actor3});
        Film film3 = new Film(2014, "Soya", new Actor[]{actor1, actor2, actor3});
        Film film4 = new Film(2013, "Altfilm", new Actor[]{actor2, actor1});
